      ...
      <header className="glass-effect backdrop-blur-xl py-2 sm:py-4 px-4 sm:px-6 relative z-10 border-b border-white/20">
        <nav className="container mx-auto flex justify-between items-center">
              <img
                ...
                srcSet="/lovable-uploads/08bb4537-9151-4684-bf39-abc2900ea374-48.webp 48w, /lovable-uploads/08bb4537-9151-4684-bf39-abc2900ea374-96.webp 96w"
                sizes="48px"
                alt="LEST TAXI logo"
                width="48"
                height="48"
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col items-center lg:items-center text-center">
              <img
                src="/lovable-uploads/2c4085f5-69ea-4561-baae-9a987e4939e7.webp"
                srcSet="/lovable-uploads/2c4085f5-69ea-4561-baae-9a987e4939e7-320.webp 320w, /lovable-uploads/2c4085f5-69ea-4561-baae-9a987e4939e7-480.webp 480w, /lovable-uploads/2c4085f5-69ea-4561-baae-9a987e4939e7-640.webp 640w"
                sizes="(max-width: 640px) 320px, (max-width: 768px) 480px, 640px"
                alt="LEST TAXI vehicle"
                width="640"
                height="480"
                loading="eager"
                decoding="async"
