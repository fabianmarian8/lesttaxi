        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col items-center lg:items-center text-center">
              <img src="/images/hero-taxi-640.webp" srcSet="/images/hero-taxi-320.webp 320w, /images/hero-taxi-480.webp 480w, /images/hero-taxi-640.webp 640w" sizes="(max-width: 640px) 320px, (max-width: 768px) 480px, 640px" alt="Professional white Toyota taxi vehicle ready for military personnel transport at Lest Base" className="rav4-image rounded-xl w-full max-w-xs sm:max-w-md lg:max-w-lg shadow-2xl" width={640} height={480} decoding="async" fetchPriority="high" />
