        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col items-center lg:items-center text-center">
              <img src="/cdn-cgi/image/width=320,height=240,fit=cover,quality=70,format=auto/lovable-uploads/2c4085f5-69ea-4561-baae-9a987e4939e7.webp" alt="Professional white Toyota taxi vehicle ready for military personnel transport at Lest Base" className="rav4-image rounded-xl w-full max-w-xs sm:max-w-md lg:max-w-lg shadow-2xl" width="320" height="240" decoding="async" fetchPriority="high" />
