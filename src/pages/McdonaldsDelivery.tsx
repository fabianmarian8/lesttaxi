...
const McdonaldsDelivery = () => {
  ...
  const mcdonaldsLocations = [
    { name: "McDonald's Zvolen", distance: "15 km", time: "18 min", address: "Zvolen Shopping Center" },
    { name: "McDonald's Banská Bystrica", distance: "25 km", time: "30 min", address: "Europa Shopping Center" },
    { name: "McDonald's Highway A1", distance: "20 km", time: "25 min", address: "Highway Rest Stop" },
  ];
